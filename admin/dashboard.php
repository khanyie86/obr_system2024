            ...
            <div class="chart-placeholder">
                ...
                <div class="container">
                    ...
                    try {
                        ...
                        if ($parent) {
                            $parent_email = $parent['admin_email'];
                            $parent_name = $parent['admin_surname'];
                        } else {
                    ...
                    try {
                        ...
                        $stmt = $db->prepare("SELECT * FROM `learner`");
                        $stmt->execute();
                    ...
                    <h3>Your Admin Portal</h3><a href="add_learner.php">Add Child</a>
