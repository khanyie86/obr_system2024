            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Logged in as <?php echo htmlspecialchars($_SESSION['admin_surname']); ?>
                    </a>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="position-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="add_learner.php"><i class="fas fa-user"></i> Register Learner</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="apply_bus.php"><i class="fas fa-cog"></i> Apply for the Bus</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="student_app.php"><i class="fas fa-cog"></i> Applications</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="user.php"><i class="fa fa-users" aria-hidden="true"></i> Users</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="mis_report.php"><i class="fa fa-bar-chart" aria-hidden="true"></i> MIS Reports</a>
                    </li>
                </ul>
            </div>
        </nav>